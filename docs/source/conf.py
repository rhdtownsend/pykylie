...
release = version
branch = 'main'
copyright = '2024-2026, Rich Townsend & The PyKYLIE Team'
...
extlinks = {
    ...
    'repo': ('https://github.com/rhdtownsend/pykylie/blob/{:s}/%s'.format(branch), None),
    'mad-star': ('http://user.astro.wisc.edu/~townsend/static.php?ref=%s', None),
    'mad-star-down': ('http://user.astro.wisc.edu/~townsend/resource/download/%s', None)
}
...
intersphinx_mapping = {
    ...
    'msg': ('https://msg.readthedocs.io/en/stable', None),
